...
| --- | --- |
| `/` | Главная |
| `/projects/:slug` | Кейс (`infrastructure-platform`, `corporate-platform-modernization`, `geoinformation-platform`) |
...
Текущие четыре изображения вырезаны из растрового макета 1024 px (hero 520×372, кейсы 625×205 / 190×190 / 215×190). Это временные ресурсы низкого разрешения: на экранах 1440+ и retina они мягче, чем нужно. Для финала нужны отдельные исходники в той же палитре по ориентирам: hero ≈1600×1400, инфраструктура ≈1800×800, модернизация и ГИС ≈900×800, формат WebP.
